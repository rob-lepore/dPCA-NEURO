...
% first dimension corresponds to neurons and the rest D dimensions to various 
% parameters.
% 
% YY is a cell array of marginalized datasets, containing 2^D-1 arrays,
