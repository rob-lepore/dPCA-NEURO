function [optimalLambda, optimalLambdas] = dpca_optimizeLambda(Xfull, ...
    Xtrial, numOfTrials, dataname, varargin)
...
if strcmp(options.display, 'yes')
    figure('Render', "painters", 'Position', [0 0 1800 1000], ...
    'Name', 'Relative cross-validation errors')
    
    title('Relative cross-validation errors - ' + dataname + ' -  Fig.3')
